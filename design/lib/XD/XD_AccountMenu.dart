...
class XD_AccountMenu extends StatelessWidget {
  XD_AccountMenu({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_r165ko =
    '<svg viewBox="12.5 250.0 350.0 1.0" ><path transform="translate(12.5, 250.0)" d="M 0 0 L 350 0" fill="none" stroke="#e0e0e0" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
